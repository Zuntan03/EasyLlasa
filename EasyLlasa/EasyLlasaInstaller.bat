...
@REM if /i not "%DOWNLOAD_MODEL_YES_OR_NO%" == "n" (
@REM 	call %~dp0%PROJECT_NAME%\AutoDownload_Enable.bat
@REM 	@REM call %EASY_TOOLS_DIR%\Civitai\Civitai_ApiKey.bat
@REM )
